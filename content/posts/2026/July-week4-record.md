...
description: "코스피 -1.91%, 나스닥 -2.13%. 계좌는 +0.78%로 5주 만에 보합 전환. 샌디스크 +6.03% 상승, 알파벳 신규 매수."
...
평가금은 1억 7,148만원에서 **1억 7,283만원**으로 134만원 늘었다. 이 중 100만원은 이번 주 입금이라 실제 투자손익은 **34만원, +0.20%** 다. 4주 연속 마이너스를 끊었다는 게 이번 주의 의미다.
...
이번주는 일일레포트도 만들었다. AI 도움으로 매일 변동성을 확인하는 용도로 사용할 예정이다.

![일일 리포트](/images/july-week4-daily-report.png)
...
- **국장 향방**: 7월 25일 토요일 샌프란시스코 AI 회동으로 훈풍이 예상된다. 여전히 레버리지 영향이 남아 있는 가운데 어느 정도 반등을 이끌지 기대된다. 펀더멘털은 견고한 가운데 수급 이슈를 어떻게 소화할까? 지금처럼 한풀 꺾이고 밸류가 싸질때 개인이 추가 매수해야 하는데 개인은 일반적으로 반대로 행동한다. 실제로 예수금은 줄어들었고. 모두들 간다하며 분위기가 달아올랐을 때 개인은 들어가고 지금처럼 하락하면 떨어지는 악순환을 되풀이한다. 안타깝다.
