...
이번 주 평가금이 2억 1,972만원에서 **2억 1,072만원**으로 900만원 줄었다. 입금은 없었으니 전액 투자 손실이다.
...
이상한 건 삼성전자가 역대급 실적을 냈는데도 국장이 약했다는 점이다. 실적과 무관하게 국내 레버리지 상품 청산 수급이 지수를 눌렀다. 하이닉스 ADR 상장이 마무리되는 과정에서 파생·레버리지 쪽 수급이 꼬였고, 그게 메모리 3대장을 다 같이 끌어내렸다. 펀더멘털 이슈는 아니다. 하이닉스 ADR은 이번 주 상장이 완료됐으니 수급 이슈는 이제 잠잠해질 것으로 본다.

**하이닉스가 -10.10%, 삼성전자가 -7.92%로 국장 메모리가 크게 빠졌다.** 반대로 **샌디스크는 +9.79%로 반등했다.** 지난주 -16.54%로 가장 크게 빠졌던 종목이 이번 주엔 계좌를 방어했다. 국장 비중이 66.83%에서 63.20%로 줄고 미장이 31.67%에서 35.92%로 늘었다. 오래 신경 쓴 분산이 이런 국면에서 조금은 작동했다.

평가금은 6월 고점 2억 5천에서 지금 2억까지 내려왔다. 최대 낙폭(MDD)으로 치면 20% 수준이다. 견딜 만하다. 연간으로는 여전히 100%를 넘고 펀더멘털도 양호하다. 담쌤과 텃밭 커뮤니티 덕분에 크게 동요하지 않고 버티는 중이다. 하락 구간이지만 다시 좋아질 거라 생각한다.

국장 종목 중엔 메모리 밖 손실이 크다. 삼성전기 -22.36%, 현대모비스 -21.90%, LIG넥스원 -19.21%. 방산·모비스·삼성전기가 다 같이 -20% 안팎이다. 이 중 한화에어로스페이스는 -31%에서 전량 매도했다. 손실 관리 원칙에 따라 잘랐다. LIG넥스원은 아직 유지한다.
...
- 누적 이익: **1억 1,751만원** (1억 2,651만 → 1억 1,751만, -900만)
- 누적 수익율: **126.07%** (135.73% → 126.07%)
- 연간 이익: 1억 664만원
- 월간 수익: -3,035만원 (7월 누적)
- 주간 투자손익: **-900만원 / -4.10%**
- 배당+이자: 0.2만원
...
**삼성전자·마벨 저점 매수**: 7/7 삼성전자 2주, 7/8 마벨 1주를 저점에서 추가했다. 삼성전자는 사고도 아직 회복을 못 하고 있다.

---

## 다음 주 관전 포인트

- **하닉 ADR 상장 완료 후 수급**: 상장이 마무리됐으니 국장 메모리 수급이 정상화될지.
- **삼성전자 실적 반영**: 역대급 실적이 주가에 언제 반영될지.
- **국장/미장 디커플링**: 이번 주처럼 갈리는 흐름이 이어질지, 코스피 7천선을 지킬지.
- **MDD 대응**: 고점 대비 20% 내려온 국면에서 추가 하락 시 어떻게 대응할지.
